...
class TowerorPolesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_towersorpoles, container, false)
        ...
        val zone = arrayListOf("Select Make","Aashutosh","Shambhav","Shubham","Manish","Ashok")
